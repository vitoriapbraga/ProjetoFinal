...
#define RAY_LIGHTGRAY  CLITERAL(Color){ 200, 200, 200, 255 }   // Light Gray
#define RAY_GRAY       CLITERAL(Color){ 130, 130, 130, 255 }   // Gray
#define RAY_DARKGRAY   CLITERAL(Color){ 80, 80, 80, 255 }      // Dark Gray
#define RAY_YELLOW     CLITERAL(Color){ 253, 249, 0, 255 }     // Yellow
#define RAY_GOLD       CLITERAL(Color){ 255, 203, 0, 255 }     // Gold
#define RAY_ORANGE     CLITERAL(Color){ 255, 161, 0, 255 }     // Orange
#define RAY_PINK       CLITERAL(Color){ 255, 109, 194, 255 }   // Pink
#define RAY_RED        CLITERAL(Color){ 230, 41, 55, 255 }     // Red
#define RAY_MAROON     CLITERAL(Color){ 190, 33, 55, 255 }     // Maroon
#define RAY_GREEN      CLITERAL(Color){ 0, 228, 48, 255 }      // Green
#define RAY_LIME       CLITERAL(Color){ 0, 158, 47, 255 }      // Lime
#define RAY_DARKGREEN  CLITERAL(Color){ 0, 117, 44, 255 }      // Dark Green
#define RAY_SKYBLUE    CLITERAL(Color){ 102, 191, 255, 255 }   // Sky Blue
#define RAY_BLUE       CLITERAL(Color){ 0, 121, 241, 255 }     // Blue
#define RAY_DARKBLUE   CLITERAL(Color){ 0, 82, 172, 255 }      // Dark Blue
#define RAY_PURPLE     CLITERAL(Color){ 200, 122, 255, 255 }   // Purple
#define RAY_VIOLET     CLITERAL(Color){ 135, 60, 190, 255 }    // Violet
#define RAY_DARKPURPLE CLITERAL(Color){ 112, 31, 126, 255 }    // Dark Purple
#define RAY_BEIGE      CLITERAL(Color){ 211, 176, 131, 255 }   // Beige
#define RAY_BROWN      CLITERAL(Color){ 127, 106, 79, 255 }    // Brown
#define RAY_DARKBROWN  CLITERAL(Color){ 76, 63, 47, 255 }      // Dark Brown

#define RAY_WHITE      CLITERAL(Color){ 255, 255, 255, 255 }   // White
#define RAY_BLACK      CLITERAL(Color){ 0, 0, 0, 255 }         // Black
#define RAY_BLANK      CLITERAL(Color){ 0, 0, 0, 0 }           // Blank (Transparent)
#define RAY_MAGENTA    CLITERAL(Color){ 255, 0, 255, 255 }     // Magenta
#define RAY_RAYWHITE   CLITERAL(Color){ 245, 245, 245, 255 }   // My own White (raylib logo)
